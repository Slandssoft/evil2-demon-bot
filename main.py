...
Инструкция: замени YOR_BOT_TOKEN_HERE и OWNER_ID на свои
"""
...
# ========== ТВОИ ДАННЫЕ (ЗАМЕНИ ЭТО!!!) ==========
BOT_TOKEN = "8611498047:AAF4IGy-mV-GN4MfvDBrzGDuiotPqWLMyqE"  # Сюда вставь токен от @BotFather
OWNER_ID = 6376163988  # Сюда вставь свой ID (узнай у @userinfobot)
# =================================================
